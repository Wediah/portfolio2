        ...
        <Element id="services" name="services">
            <div className="min-h-screen px-10 " >
                ...
                <div className=" gap-10 lg:flex pt-10">
                    <div className="shadow-2xl rounded-3xl text-center p-16 my-10 flex-1 hover:outline hover:outline-2 hover:outline-gray-500 hover:outline-offset-4 bg-gray-100">
