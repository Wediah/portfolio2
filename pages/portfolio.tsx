             ...
             <h3 className="text-md font-light  text-center">What I have done</h3>
                <div className="flex flex-col py-10 gap-10 lg:flex-row lg:flex-wrap">
                    <div className="basis-1/3 flex-1">
                        ...
                        <h3 className="font-medium text-md">Modern Website</h3>
                    </div>
                    <div className="basis-1/3 flex-1">
                    ...
                    <div className="basis-1/3 flex-1">
                        ...
                        <h3 className="font-medium text-2xl">UX/UI Design</h3>
                        <h3 className="font-medium text-md">Ecommerce shop</h3>
                    </div>
                    <div className="basis-1/3 flex-1 ">
                     ...
                     <h3 className="font-medium text-md">Modern Website</h3>
                     <a href="https://engec.netlify.app/" ><button className="flex text-sm mt-4 bg-gray-100 p-2 rounded-full">View website <AiOutlineArrowRight className="text-xl ml-2"/> </button></a>
                    </div>
                </div>
