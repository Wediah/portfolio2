            ...
            <div className="min-h-screen px-10">
                ...
                <div className=" gap-10 lg:flex pt-10">
                    <div className="shadow-2xl rounded-3xl text-center p-10 my-10 flex-1 bg-gray-100">
                        ...
                        <h5 className="flex text-md pt-1"> <GoPrimitiveDot className="text-xl text-center "/>Developing websites for brands. </h5>
                        <h5 className="flex text-md pt-1"> <GoPrimitiveDot className="text-xl text-center "/>Updating and implementing features in website. </h5>
                    </div>
                    <div className="shadow-2xl rounded-3xl text-center p-10 my-10 flex-1 bg-gray-100">
                    <h4 className="text-2xl font-semibold">Front-end Developer - Intern at <a href="http://insti.csir.org.gh/"><span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500">CSIR-INSTI</span></a></h4>
                        ...
                        <h5 className="flex text-md pt-1"> <GoPrimitiveDot className="text-xl text-center"/>Testing and debugging bugs in website. </h5>
                    </div>
                </div>
