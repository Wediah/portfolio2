    ...
    return (
        <Element id="home" name="home">
            <div className="min-h-screen px-10 " >
                <h1 className="pt-60 md:pt-80 text-6xl font-bold pb-4">
                    Hi, there! <br />
                ...
                <h2 className="font-bold text-slate-500 pb-4">
                ...
                <h4 className="pt-16 md:pt-32 text-blue-300 font-bold text-sm animate-bounce font-mono">
